...
int CBox::numOfTris = 12;
int CBox::numOfVerts = 8;
...
void CBox::constructGeometry(CShader* myShader, float minx, float miny, float minz, float maxx, float maxy, float maxz)
{
	// First simple object
	...
	cols[3] = 0.0;   cols[ 4] = 0.0;  cols[ 5] = 0.0;
	cols[6] = 0.0;   cols[ 7] = 0.0;  cols[ 8] = 0.0;
	cols[9] = 0.0;   cols[10] = 0.0;  cols[11] = 0.0;

	cols[12] = 0.0;   cols[13] = 0.0;  cols[14] = 0.0;
	cols[15] = 0.0;   cols[16] = 0.0;  cols[17] = 0.0;
	cols[18] = 0.0;   cols[19] = 0.0;  cols[20] = 0.0;
	cols[21] = 0.0;   cols[22] = 0.0;  cols[23] = 0.0;
