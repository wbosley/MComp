...
public:
	...
	void						InitVBO(GLuint jerryRig);
	void						DrawElementsUsingVBO(GLuint jerryRig);
	void						DrawBoundingBox(GLuint jerryRig);
	void						DrawAllBoxesForOctreeNodes(GLuint jerryRig);
	void						DrawOctreeLeaves(GLuint jerryRig);
