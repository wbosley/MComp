 ...
 *	Returns	: void
 */
void CThreeDModel::InitVBO(GLuint jerryRig)
{
	CalcFaceNormals();
	...
	GLint vertexLocation = glGetAttribLocation(jerryRig, "in_Position");
	...
	GLint normalLocation = glGetAttribLocation(jerryRig, "in_Normal");
	...
	GLint texCoordLocation = glGetAttribLocation(jerryRig, "in_TexCoord");
 ...
 *	Returns	: void
 */
void CThreeDModel::DrawElementsUsingVBO(GLuint jerryRig)
{
	glBindVertexArray(m_uiVaoID);

	glUniform1i(glGetUniformLocation(jerryRig, "DiffuseMap"), 0);
